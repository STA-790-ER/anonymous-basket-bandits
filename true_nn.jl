...
dat = CSV.File("/hpc/group/laberlabs/jml165/truevalcombresults/truevalcombresults_$(idx).csv") |> Tables.matrix
...
CSV.write("/hpc/home/jml165/rl/trueneuralnetscales/scales_$(idx).csv", Tables.table([means stds]), writeheader = false)
...
@save "/hpc/home/jml165/rl/truevalneuralnets/valnn_$(idx).bson" m
