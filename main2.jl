...
const n_opt_rollouts = 15000# 10000hh0
...
## DP PARAM
const dp_rollout_count = 3000
const dp_within_rollout_count = 300
const num_round  = 3
const dp_length = 3
...
const run_policies = [greedy_policy, thompson_policy, bayes_ucb_policy, ids_policy, dp_valcheck_greedy_thompson_ucb_ids_policy]
#const run_policies = [vb_greedy_policy, vb_thompson_policy, vb_glm_ucb_policy, vb_ids_policy, dp_valcheck_vb_bernoulli_val_greedy_thompson_ucb_ids_policy]
#const run_policies = [greedy_policy, thompson_policy, bayes_ucb_policy, ids_policy]
