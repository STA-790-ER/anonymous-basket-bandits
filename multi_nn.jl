...
CSV.write("/hpc/home/jml165/rl/multineuralnetscales/multiscales_$(idx).csv", Tables.table([means stds]), writeheader = false)
...
@save "/hpc/home/jml165/rl/multivalneuralnets/multivalnn_$(idx).bson" m
